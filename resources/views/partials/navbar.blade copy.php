  ...
  <div class="container">
    <div class="d-flex align-items-center justify-content-between" style="height: 64px;">
      ...
      <div class="d-none d-md-flex align-items-center gap-4">
        <a href="#work" class="nav-link"
          style="color:var(--fg-dim);text-decoration:none;font-size:14px;transition:color .2s;">Work</a>
        <a href="#stack" class="nav-link"
          style="color:var(--fg-dim);text-decoration:none;font-size:14px;transition:color .2s;">Stack</a>
        <a href="#blog" class="nav-link"
          style="color:var(--fg-dim);text-decoration:none;font-size:14px;transition:color .2s;">Blog</a>
    ...
    <div class="collapse d-md-none" id="mobileNav">
      <div class="d-flex flex-column gap-3 py-3" style="border-top:1px solid var(--border);">
        <a href="#work" class="nav-link" style="color:var(--fg-dim);text-decoration:none;font-size:14px;">Work</a>
        <a href="#stack" class="nav-link" style="color:var(--fg-dim);text-decoration:none;font-size:14px;">Stack</a>
        <a href="#blog" class="nav-link" style="color:var(--fg-dim);text-decoration:none;font-size:14px;">Blog</a>
